...
def build_steps(context: BuildContext) -> list[WorkflowStep]:
    ...
    command = [
        ...
        str(int_config(config, "llm_rerank_max_query_article_chars", 0)),
        "--llm-rerank-max-candidate-chars",
        str(int_config(config, "llm_rerank_max_candidate_chars", 0)),
...
node_spec = WorkflowNodeSpec(
    ...
    default_config={
        ...
        "llm_rerank_top_n": 15,
        "llm_rerank_max_query_article_chars": 0,
        "llm_rerank_max_candidate_chars": 0,
    ...
    fields=(
        ...
        WorkflowFieldSpec(
            ...
            type="number",
            description="0 nghĩa là không cắt text article trong prompt rerank.",
            configurable=False,
            min=0.0,
            step=100.0,
        ),
        WorkflowFieldSpec(
            ...
            type="number",
            description="0 nghĩa là không cắt chunk/context trong prompt rerank.",
            configurable=False,
            min=0.0,
            step=100.0,
        ),
