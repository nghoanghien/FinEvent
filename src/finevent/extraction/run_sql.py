        ...
        connection.execute(
            sql(
                ...
                VALUES (
                    ...
                    CAST(:verification_report AS JSONB),
                    CAST(:hallucination_metrics AS JSONB),
                ...
                DO UPDATE SET
                    ...
                    hallucination_metrics = EXCLUDED.hallucination_metrics,
            ...
            ),
            {
                ...
                "reasoning_trace": _json(state.reasoning_trace or {}),
                "validation_issues": _json(state.validation_issues),
                "verification_report": _json(state.verification_report or {}),
                "hallucination_metrics": _json(state.hallucination_metrics or {}),
